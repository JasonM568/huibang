...
const services = [
  {
    ...
    desc: "【待補：品牌定位服務說明，約 3-4 句話。例如：透過系統化的市場分析、競品研究與消費者洞察，協助品牌找到獨特的市場定位與價值主張。】",
    features: [
      "市場分析與競品研究",
      "品牌核心價值梳理",
      "目標客群定義與分析",
  ...
  },
  {
    ...
    desc: "【待補：廣告投放服務說明，約 3-4 句話。例如：在 Facebook、Instagram、Google、LINE 等主流平台進行精準的廣告投放，以數據分析持續優化投放策略。】",
    features: [
  ...
  },
  {
    ...
    title: "社群經營管理",
    tagline: "打造有溫度的品牌社群",
    desc: "【待補：社群經營服務說明，約 3-4 句話。例如：從內容策略、視覺設計到社群互動，全方位管理品牌社群平台，建立忠實的粉絲社群。】",
    features: [
      "社群內容策略規劃",
      "貼文文案與視覺設計",
      "社群互動與粉絲經營",
  ...
  },
  {
    ...
    desc: "【待補：內容行銷服務說明，約 3-4 句話。例如：透過高品質的內容創作，幫助品牌建立專業形象、累積自然流量，並轉化為長期的品牌資產。】",
    features: [
      "SEO 內容策略",
      "部落格與專欄文章",
      "影音內容企劃",
        ...
        <div className="max-w-6xl mx-auto px-6">
          <motion.div {...fadeUp} className="max-w-3xl">
            ...
            <p className="text-dark-400 text-lg leading-relaxed">
              【待補：服務總覽說明，約 2-3 句話。例如：惠邦行銷提供從品牌定位、廣告投放到社群經營的完整數位行銷服務，助力品牌在競爭中脫穎而出。】
            </p>
          </motion.div>
        </div>
      </section>
